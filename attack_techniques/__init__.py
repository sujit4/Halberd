...
from .azure.azure_abuse_azure_policy_to_disable_logging import (
    AzureAbuseAzurePolicyToDisableLogging,
)
...
from .azure.azure_deploy_malicious_extension_on_vm import (
    AzureDeployMaliciousExtensionOnVM,
)
from .azure.azure_disable_resource_diagnostic_logging import (
    AzureDisableResourceDiagnosticLogging,
)
from .azure.azure_disable_storage_account_firewall import (
    AzureDisableStorageAccountFirewall,
)
...
from .azure.azure_enable_storage_account_public_access import (
    AzureEnableStorageAccountPublicAccess,
)
...
# Azure Techniques
from .azure.azure_establish_access_via_device_code import (
    AzureEstablishAccessViaDeviceCode,
)
from .azure.azure_execute_script_on_vm import AzureExecuteScriptOnVM
from .azure.azure_exfil_storage_account_container import (
    AzureExfilStorageAccountContainer,
)
from .azure.azure_exfil_vm_disk import AzureExfilVMDisk
from .azure.azure_expose_storage_account_container_public import (
    AzureExposeStorageAccountContainerPublic,
)
...
from .azure.azure_scan_logic_apps_for_credentials import (
    AzureScanLogicAppsForCredentials,
)
...
from .gcp.gcp_enumerate_compute_engine_instances import (
