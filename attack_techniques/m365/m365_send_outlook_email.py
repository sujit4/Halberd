...
class M365SendOutlookEmail(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            "Send Outlook Email",
            "Send email using users mailbox potentially attempting spear-phishing attack",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            if (
                user_id in [None, ""]
                or to_recipient in [None, ""]
                or subject in [None, ""]
                or email_content in [None, ""]
                or hide_from_mailbox in [None, ""]
            ):
            ...
            data = {
                "message": {
                    "subject": subject,
                    "body": {"contentType": "Text", "content": email_content},
            ...
            if 200 <= raw_response.status_code < 300:
                return ExecutionStatus.SUCCESS, {
                    "message": "Successfully sent email from users mailbox",
                    "value": {
                        "sender": user_id,
                ...
                return ExecutionStatus.FAILURE, {
                    "error": {
                        ...
                        .get("error")
                        .get("code", "N/A"),
                        "eror_message": raw_response.json()
                        .get("error")
                        .get("message", "N/A"),
                    },
