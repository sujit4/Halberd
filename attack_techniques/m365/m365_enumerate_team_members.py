...
class M365EnumerateTeamMembers(BaseTechnique):
    def __init__(self):
        ...
        technique_notes = [
            TechniqueNote(
                "Enumerate membership of multiple teams by adding multiple Team IDs separated by comma in the input"
            )
        ]
        ...
        try:
            ...
            for team_id in team_list:
                ...
                for member in raw_response:
                    ...
                    if (
                        not include_guest_members
                        and "guest" in member.get("userType", "").lower()
                    ):
                        continue
