...
class M365DeployEmailFrwdRule(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "Sets up email forwarding rule on target user mailbox",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            if (
                rule_name in [None, ""]
                or user_id in [None, ""]
                or recipient_name in [None, ""]
                or recipient_address in [None, ""]
            ):
            ...
            if 200 <= raw_response.status_code < 300:
                return ExecutionStatus.SUCCESS, {
                    "message": "Successfully deployed email forwarding rule on mailbox",
                    "value": {
                        "rule_name": rule_name,
