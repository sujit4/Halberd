...
class M365EnumerateTeams(BaseTechnique):
    def __init__(self):
        ...
        technique_notes = [
            TechniqueNote(
                "Private Teams won't appear in results unless the user is a member"
            ),
            TechniqueNote(
                "Team discovery is often a starting point for more targeted data collection techniques"
            ),
        ]
        ...
        try:
            ...
            for team in teams:
                team_data = {
                    ...
                    "isMembershipLimitedToOwners": team.get(
                        "isMembershipLimitedToOwners", "N/A"
                    ),
            ...
            if team_id and processed_teams:
                ...
                return ExecutionStatus.SUCCESS, {
                    ...
                    "value": {
                        "result": f"Successfully enumerated {len(processed_teams)} Teams",
                        "team_details": processed_teams,
                    },
                }
