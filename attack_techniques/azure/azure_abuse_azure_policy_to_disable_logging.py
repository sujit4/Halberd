...
class AzureAbuseAzurePolicyToDisableLogging(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "This technique uses a malicious DeployIfNotExists policy primarily focused on Defense Evasion by impairing logging and monitoring capabilities in Azure through manipulation of the Azure Policy service.",
            mitre_techniques,
            azure_trm_technique,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            policy_definition_name: str = kwargs.get(
            ...
            print(
                f"Policy '{policy_assignment.name}' assigned to resource group '{resource_group_name}'."
            )
            ...
            if response.status_code == 200 or response.status_code == 201:
                print(
                    f"Remediation task '{remediation_task_name}' created to enforce logging settings."
                )
            else:
    ...
    def get_parameters(self) -> Dict[str, Dict[str, Any]]:
        return {
            ...
            "policy_definition_name": {
                "type": "str",
                "required": False,
                "default": "DisableDiagnosticSettingsPolicy",
