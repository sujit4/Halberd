        ...
        try:
            ...
            if not token_path:
                token_path = os.path.expanduser(
                    os.path.join("~", ".azure", "msal_token_cache.json")
                )
            ...
            extracted_tokens = {"access_tokens": [], "refresh_tokens": []}

            # Extract refresh tokens
            if "RefreshToken" in token_data and isinstance(
                token_data["RefreshToken"], dict
            ):
            ...
            if "AccessToken" in token_data and isinstance(
                token_data["AccessToken"], dict
            ):
            ...
            if (
                not extracted_tokens["access_tokens"]
                and not extracted_tokens["refresh_tokens"]
            ):
                return ExecutionStatus.FAILURE, {
