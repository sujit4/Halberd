...
class AzureCreateNewResourceGroup(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "Creates new resource group in the target Azure subscription",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            rg_object = {"location": new_rg_location}
            ...
            return ExecutionStatus.SUCCESS, {
                ...
                "value": {"rg_ame": new_rg.name, "rg_location": new_rg.location},
            }
    ...
    def get_parameters(self) -> Dict[str, Dict[str, Any]]:
        return {
            "new_rg_name": {
                ...
                "required": True,
                "default": None,
                "name": "New Resource Group Location",
