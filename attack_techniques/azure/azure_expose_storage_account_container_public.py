...
class AzureExposeStorageAccountContainerPublic(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "Modifies access controls on Azure Storage Account containers to enable anonymous public access. The technique can set container access level to either 'blob' (allowing public read access to blob data) or 'container' (allowing public read and list access to entire containers). This intentional exposure of private data makes container contents publicly accessible over the internet without authentication. This technique is particularly impactful as storage containers often hold sensitive business data, backups, and application files.",
            mitre_techniques,
        )
