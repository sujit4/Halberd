...
class AzureDisableStorageAccountFirewall(BaseTechnique):
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            storage_client.storage_accounts.update(rg_name, account_name, update_params)

            network_rule_set = NetworkRuleSet(default_action=DefaultAction.ALLOW)
