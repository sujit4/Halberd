...
class AzureExfilStorageAccountContainer(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            "Exfil Storage Account Container",
        ...
        try:
            ...
            if connection_string:
                ...
                blob_service_client = BlobServiceClient(
                    account_url=account_url, connection_verify=False
                )
    ...
    def get_parameters(self) -> Dict[str, Dict[str, Any]]:
        return {
            ...
            "connection_string": {
                ...
                "required": False,
                "default": None,
                "name": "Connection String (For Private Container)",
                "input_field_type": "text",
            },
            "container_url": {
                "type": "str",
                "required": False,
                "default": None,
                "name": "Container URL (For Public Container)",
                "input_field_type": "text",
            },
        }
