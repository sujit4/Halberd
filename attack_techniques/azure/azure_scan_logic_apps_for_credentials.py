...
class AzureScanLogicAppsForCredentials(BaseTechnique):
    ...
    def _scan_for_credentials(
        self, content: str, confidence_level: str, search_pattern: str = None
    ) -> List[Dict[str, Any]]:
        ...
        if search_pattern:
            ...
            for match in matches:
                secret = next(
                    (g for g in match.groups() if g is not None), match.group(0)
                )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            confidence_level: str = kwargs.get(
            ...
            return ExecutionStatus.SUCCESS, {
                ...
                "value": {"findings": findings, "statistics": stats},
            }
