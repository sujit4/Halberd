...
class AzureEnumerateResources(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            "Enumerate Resources",
            "Enumerates resources in a target Azure resource group",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            resources = [
                {
                    "resource_name": resource_list_object.name,
                    "resource_type": resource_list_object.type,
                    "resource_id": resource_list_object.id,
                }
                for resource_list_object in resources_list
            ]
