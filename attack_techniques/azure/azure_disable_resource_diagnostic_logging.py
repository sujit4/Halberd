...
class AzureDisableResourceDiagnosticLogging(BaseTechnique):
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            delete_all_diagnostic_settings_for_resource: bool = kwargs.get(
                "delete_all_diagnostic_settings_for_resource", False
            )
            ...
            if (
                diagnostic_setting_name in ["", None]
                and not delete_all_diagnostic_settings_for_resource
            ):
                return ExecutionStatus.FAILURE, {
                    "error": "Invalid Technique Input",
            ...
            if diagnostic_setting_name:
                monitor_client.diagnostic_settings.delete(
                    resource_uri, diagnostic_setting_name
                )
    ...
    def get_parameters(self) -> Dict[str, Dict[str, Any]]:
        return {
            ...
            "delete_all_diagnostic_settings_for_resource": {
                "type": "bool",
                "required": False,
                "default": False,
                "name": "Find and Delete All Diagnostic Setting for Resource",
