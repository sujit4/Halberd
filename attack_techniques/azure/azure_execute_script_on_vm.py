...
class AzureExecuteScriptOnVM(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "Run arbitrary scripts or commands on the target VMs by utilizing the 'RunCommand' feature on a Virtual Machine Scale Set (VMSS). This capability allows installation of malicious software, exfiltrate data, or perform other nefarious activities, potentially compromising the VM instances within the scale set.",
            mitre_techniques,
            azure_trm_technique,
        )
        ...
        try:
            ...
            if os_type == "Windows":
                run_command_parameters = {
                    ...
                    "script": ["Write-Output 'Hello, this is Halberd!'"],
                }
            else:
                run_command_parameters = {
                    "command_id": "RunShellScript",
                    "script": ["echo 'Hello, this is Halberd!'"],
                }
