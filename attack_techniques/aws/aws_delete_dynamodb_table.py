...
class AWSDeleteDynamoDBTable(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "Deletes a table in DyanmoDB for data destruction",
            mitre_techniques,
        )
        ...
        try:
            ...
            if 200 <= raw_response["ResponseMetadata"]["HTTPStatusCode"] < 300:
                return ExecutionStatus.SUCCESS, {
                    ...
                    "value": {
                        "table_name": raw_response.get("TableDescription", "N/A").get(
                            "TableName", "N/A"
                        ),
                        "table_size_in_bytes": raw_response.get(
                            "TableDescription", "N/A"
                        ).get("TableSizeBytes", "N/A"),
                        "item_count": raw_response.get("TableDescription", "N/A").get(
                            "ItemCount", "N/A"
                        ),
                        "tabke_status": raw_response.get("TableDescription", "N/A").get(
                            "TableStatus", "N/A"
                        ),
                    },
                }
