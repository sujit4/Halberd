...
class AWSExposeS3BucketPublic(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "This module attempts to enable public read access to the bucket by creating a bucket policy and applying it to the target bucket.",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            raw_response = my_client.put_bucket_policy(
            ...
            return ExecutionStatus.SUCCESS, {
                ...
                "value": {"bucket_name": bucket_name, "public_access": "enabled"},
            }
