...
class AWSReconS3PublicBuckets(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "This module identifies public S3 buckets in an AWS environment. This technique scans all S3 buckets in the account and checks their access control lists (ACLs) and policies to determine if they are publicly accessible.",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            return ExecutionStatus.SUCCESS, {
                "message": f"Successfully reconned {len(public_buckets)} public S3 buckets"
                if public_buckets
