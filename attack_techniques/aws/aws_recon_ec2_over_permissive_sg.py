...
class AWSReconEC2OverPermissiveSG(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "This module identifies overly permissive security group rules in an AWS environment. Its possible to exploit overly permissive security group rules to gain unauthorized access to EC2 instances or other AWS resources. This module analyzes security group rules to identify potentially risky configurations.",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            return ExecutionStatus.SUCCESS, {
                "message": f"Successfully reconned {len(permissive_rule)} overly permissive ec2 security groups"
                if permissive_rule
                else "No overly permissive ec2 security groups found",
