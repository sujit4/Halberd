...
class AWSEnumerateDynamoDBTables(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "Enumerates all tables associated with current account in DynamoDB",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            if limit in [None, ""]:
                ...
                raw_response = my_client.list_tables(Limit=limit)
            ...
            if 200 <= raw_response["ResponseMetadata"]["HTTPStatusCode"] < 300:
                ...
                return ExecutionStatus.SUCCESS, {
                    "message": f"Successfully enumerated {len(tables)} tables in DynamoDB"
                    if tables
                    else "No tables found in DynamoDB",
                    "value": tables,
                }
