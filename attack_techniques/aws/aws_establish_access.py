...
class AWSEstablishAccess(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            "Establish Access", "Creates new AWS session", mitre_techniques
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            if (
                session_name in [None, ""]
                or access_key in [None, ""]
                or secret in [None, ""]
            ):
            ...
            return ExecutionStatus.SUCCESS, {
                "message": "Successfully established access to AWS",
    ...
    def get_parameters(self) -> Dict[str, Dict[str, Any]]:
        return {
            ...
            "set_as_active_session": {
                "type": "bool",
                "required": False,
                "default": False,
                "name": "Set As Active Session?",
