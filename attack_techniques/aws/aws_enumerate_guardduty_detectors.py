...
class AWSEnumerateGuarddutyDetectors(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "Enumerates all GuardDuty detectors in the AWS account. The technique first retrieves list of all regions in the account and then enumerates through regions to get all GuardDuty detector IDs",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            return ExecutionStatus.SUCCESS, {
                "message": f"Successfully enumerated {did_count} GuardDuty detectors"
                if did_count > 0
                else "No GuardDuty detectors found",
