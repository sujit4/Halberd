...
class AWSReconAccountAuthorizationInfo(BaseTechnique):
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            filter_local_managed_policy: bool = kwargs.get(
                "filter_local_managed_policy", False
            )
            filter_aws_managed_policy: bool = kwargs.get(
            ...
            if 200 <= raw_response["ResponseMetadata"]["HTTPStatusCode"] < 300:
                ...
                return ExecutionStatus.SUCCESS, {
                    "message": "Successfully collected AWS account authorization information",
                    "value": output,
                }
            else:
    ...
    def get_parameters(self) -> Dict[str, Dict[str, Any]]:
        return {
            ...
            "filter_local_managed_policy": {
                "type": "bool",
                "required": False,
                "default": False,
                "name": "Filter Locally Managed Policies?",
                "input_field_type": "bool",
            },
            "filter_aws_managed_policy": {
                "type": "bool",
                "required": False,
                "default": False,
                "name": "Filter AWS Managed Policied?",
                "input_field_type": "bool",
            },
        }
