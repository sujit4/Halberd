...
class AWSModifyGuaddutyTrustedIP(BaseTechnique):
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            confirm_replace_existing_ip_set: str = kwargs.get(
                "confirm_replace_existing_ip_set", False
            )
            ...
            if (
                "ipSet with the given name already exists" in str(e)
                or "attempt to create resources beyond the current AWS account limits"
                in str(e)
            ):
    ...
    def get_parameters(self) -> Dict[str, Dict[str, Any]]:
        return {
            ...
            "ip_file_s3_path": {
                ...
                "required": True,
                "default": None,
                "name": "IP File S3 Public Path",
                "input_field_type": "text",
            },
            "ip_set_name": {
                "type": "str",
                "required": False,
                "default": "HalberdTrustedIPSet",
                "name": "New IP Set Name",
                "input_field_type": "text",
            },
            "confirm_replace_existing_ip_set": {
                "type": "bool",
                "required": False,
                "default": False,
                "name": "Confirm Replace Existing IP Set",
