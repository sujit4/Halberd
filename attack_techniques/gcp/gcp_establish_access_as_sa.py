...
class GCPEstablishAccessAsServiceAccount(BaseTechnique):
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            if not access_manager.get_validation():
            ...
            if access_manager.get_expired_info():
            ...
            return ExecutionStatus.SUCCESS, {
                "value": {
                    ...
                    "access_status": {
                        ...
                        "token_expiry": str(current_access.expiry)
                        if current_access.expiry
                        else None,
                    },
                },
                "message": "Successfully established access to target GCP tenant",
            }
