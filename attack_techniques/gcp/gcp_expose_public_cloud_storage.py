...
class GCPExposePublicCloudStorage(BaseTechnique):
    def __init__(self):
        ...
        technique_references = [
            TechniqueReference(
                ref_title="GCP - Make data public",
                ref_link="https://cloud.google.com/storage/docs/access-control/making-data-public",
            )
        ]
        super().__init__(
    ...
    def execute(self, **kwargs: Any) -> tuple[ExecutionStatus, dict[str, Any]]:
        ...
        try:
            ...
            if path is None or path == "":
                ...
                try:
                    managed_folder = storage_control_client.get_managed_folder(
                        request=request
                    )
                ...
                if managed_folder is None:
                    ...
                    managed_folder = storage_control_client.create_managed_folder(
                        request=request
                    )
                ...
                return ExecutionStatus.SUCCESS, {
                    ...
                    "value": {
                        ...
                        "new_policy_attached_to_path": response.json().get(
                            "bindings", []
                        ),
                    },
                }
