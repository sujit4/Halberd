...
class GCPEnumerateComputeEngineInstances(BaseTechnique):
    def __init__(self):
        ...
        technique_notes = [
            TechniqueNote(
                "Enumerate any instance require compute.instances.list permission"
            ),
            TechniqueNote("List all zone require compute.zones.list permission"),
            TechniqueNote(
                "Obtain effective firewalls require compute.instances.getEffectiveFirewalls permission"
            ),
        ]

        technique_refs = [
            TechniqueReference(
                "GCP SDK Documentation: gcloud compute instances list",
                "https://cloud.google.com/sdk/gcloud/reference/compute/instances/list",
            ),
            TechniqueReference(
                "GCP CE Regions and Zones",
                "https://cloud.google.com/compute/docs/regions-zones",
            ),
            TechniqueReference(
                "GCP CE Instance Types",
                "https://cloud.google.com/compute/docs/machine-resource",
            ),
            TechniqueReference(
                "GCP NGFW VPC Firewall Rules",
                "https://cloud.google.com/firewall/docs/firewalls",
            ),
            TechniqueReference(
                "GCP NGFW Firewall Policies",
        ...
        super().__init__(
            ...
            description=(
                "Performs comprehensive compute engine instance enumeration. "
        ...
        for instance in instances_collected._response.items:
            ...
            for disk in instance.disks:
                ...
                for network_interface in instance.network_interfaces:
                    ...
                    if firewall_detail:
                        try:
                            firewalls_associated = (
                                compute_client.get_effective_firewalls(
                                    project=project_id,
                                    zone=location,
                            ...
                            for firewall in firewalls_associated.firewalls:
                                ...
                                if firewall_type == "ALLOWED":
                                    for allowed in firewall.allowed:
                                        firewall_rule = {
                                            ...
                                            "ports": ", ".join(map(str, allowed.ports))
                                            if allowed.ports
                                            else "all ports",
                                        }
                                    ...
                                    for denied in firewall.denied:
                                        firewall_rule = {
                                            ...
                                            "ports": ", ".join(map(str, denied.ports))
                                            if denied.ports
                                            else "all ports",
                                        }
                                        firewall_rules.append(firewall_rule)
                                firewall_details = {
                                    ...
                                    **(
                                        ...
                                        if firewall_type == "ALLOWED"
                                        else {"denied": firewall_rule}
                                    ),
                                    **(
                                        {
                                            "destination_ranges": ", ".join(
                                                map(str, firewall.destination_ranges)
                                            ),
                                        }
                                        if firewall.direction == "EGRESS"
                                            ...
                                            **(
                                                {
                                                    "source_ranges": ", ".join(
                                                        map(str, firewall.source_ranges)
                                                    )
                                                }
                            ...
                            for (
                                firewall_policy
                            ) in firewalls_associated.firewall_policys:
                                ...
                                for firewall_policy_rule in firewall_policy.rules:
                                    ...
                                    for (
                                        proto_ports
                                    ) in firewall_policy_rule.match.layer4_configs:
                                        firewall_policy_rule_protos_ports.append(
                                            {
                                                "protocol": proto_ports.ip_protocol,
                                                "ports": ", ".join(
                                                    map(str, proto_ports.ports)
                                                )
                                                if proto_ports.ports
                                                else "all ports",
                                            }
                                        )
                                    for (
                                        secure_tags
                                    ) in firewall_policy_rule.match.src_secure_tags:
                                    ...
                                    if firewall_policy_rule.match.dest_region_codes:
                                        for dest_region_code in (
                                            firewall_policy_rule.match.dest_region_codes
                                        ):
                                            region_name = None
                                            match = None
                                            ...
                                            if match:
                                                ...
                                                country = pycountry.countries.get(
                                                    alpha_2=dest_region_code
                                                )
                                                region_name = (
                                                    country.name
                                                    if country
                                                    else dest_region_code
                                                )

                                            region = (
                                                f"{dest_region_code} - {region_name}"
                                            )
                                            firewall_policy_rule_dest_region.append(
                                                region
                                            )

                                    if firewall_policy_rule.match.src_region_codes:
                                        for src_region_code in (
                                            firewall_policy_rule.match.src_region_codes
                                        ):
                                            region_name = None
                                            match = None
                                            for region in not_listed_region_code:
                                            ...
                                            if match:
                                                ...
                                                country = pycountry.countries.get(
                                                    alpha_2=src_region_code
                                                )
                                                region_name = (
                                                    country.name
                                                    if country
                                                    else src_region_code
                                                )

                                            region = (
                                                f"{src_region_code} - {region_name}"
                                            )
                                            firewall_policy_rule_src_region.append(
                                                region
                                            )
                                                    ...
                                                    **(
                                                        {
                                                            "address_groups": ", ".join(
                                                                map(
                                                                    str,
                                                                    firewall_policy_rule.match.dest_address_groups,
                                                                )
                                                            )
                                                        }
                                                        if firewall_policy_rule.match.dest_address_groups
                                                        else {}
                                                    ),
                                                    **(
                                                        {
                                                            "fqdns": ", ".join(
                                                                map(
                                                                    str,
                                                                    firewall_policy_rule.match.dest_fqdns,
                                                                )
                                                            )
                                                        }
                                                        if firewall_policy_rule.match.dest_fqdns
                                                        else {}
                                                    ),
                                                    **(
                                                        {
                                                            "ip_ranges": ", ".join(
                                                                map(
                                                                    str,
                                                                    firewall_policy_rule.match.dest_ip_ranges,
                                                                )
                                                            )
                                                        }
                                                        if firewall_policy_rule.match.dest_ip_ranges
                                                        else {}
                                                    ),
                                                    **(
                                                        {
                                                        ...
                                                        if firewall_policy_rule_dest_region
                                                        else {}
                                                    ),
                                                    **(
                                                        {
                                                            "threate_intelligence": ", ".join(
                                                                map(
                                                                    str,
                                                                    firewall_policy_rule.match.dest_threat_intelligences,
                                                                )
                                                            )
                                                        }
                                                        if firewall_policy_rule.match.dest_threat_intelligences
                                                        else {}
                                                    ),
                                                }
                                            }
                                            if firewall_policy_rule.match.dest_address_groups
                                            or firewall_policy_rule.match.dest_fqdns
                                            or firewall_policy_rule.match.dest_ip_ranges
                                            or firewall_policy_rule.match.dest_region_codes
                                            or firewall_policy_rule.match.dest_threat_intelligences
                                            else {}
                                        ),
                                        **(
                                            {
                                                    ...
                                                    **(
                                                        {
                                                            "address_groups": ", ".join(
                                                                map(
                                                                    str,
                                                                    firewall_policy_rule.match.src_address_groups,
                                                                )
                                                            )
                                                        }
                                                        if firewall_policy_rule.match.src_address_groups
                                                        else {}
                                                    ),
                                                    **(
                                                        {
                                                            "fqdns": ", ".join(
                                                                map(
                                                                    str,
                                                                    firewall_policy_rule.match.src_fqdns,
                                                                )
                                                            )
                                                        }
                                                        if firewall_policy_rule.match.src_fqdns
                                                        else {}
                                                    ),
                                                    **(
                                                        {
                                                            "ip_ranges": ", ".join(
                                                                map(
                                                                    str,
                                                                    firewall_policy_rule.match.src_ip_ranges,
                                                                )
                                                            )
                                                        }
                                                        if firewall_policy_rule.match.src_ip_ranges
                                                        else {}
                                                    ),
                                                    **(
                                                        {
                                                        ...
                                                        if firewall_policy_rule_src_region
                                                        else {}
                                                    ),
                                                    **(
                                                        {
                                                            "threate_intelligence": ", ".join(
                                                                map(
                                                                    str,
                                                                    firewall_policy_rule.match.src_threat_intelligences,
                                                                )
                                                            )
                                                        }
                                                        if firewall_policy_rule.match.src_threat_intelligences
                                                        else {}
                                                    ),
                                                    **(
                                                        {
                                                            "secure_tags": firewall_policy_rule_source_secure_tags
                                                        }
                                                        if firewall_policy_rule_source_secure_tags
                                                        else {}
                                                    ),
                                                }
                                            }
                                            if firewall_policy_rule.match.src_address_groups
                                            or firewall_policy_rule.match.src_fqdns
                                            or firewall_policy_rule.match.src_ip_ranges
                                            or firewall_policy_rule.match.src_region_codes
                                            or firewall_policy_rule.match.src_threat_intelligences
                                            or firewall_policy_rule_source_secure_tags
                                            else {}
                                        ),
                                        **(
                                            {"ports": firewall_policy_rule_protos_ports}
                                            if firewall_policy_rule_protos_ports
                                            else {}
                                        ),
                                    }

                                    firewall_policy_rules.append(
                                        firewall_policy_rule_details
                                    )
                            ...
                            firewalls = sorted(
                                firewalls,
                                key=lambda x: (x["priority"], x["type"] != "DENIED"),
                            )

                            firewall_policies_priority_by_type = {
                                "HIERARCHY": 0,
                                "NETWORK": 1,
                                "NETWORK_REGIONAL": 2,
                            }
                            ...
                            firewall_policies = sorted(
                                ...
                                key=lambda x: (
                                    x["priority"],
                                    firewall_policies_priority_by_type[x["type"]],
                                ),
                            )
                        except Exception:
                            raise
                    network_interface_details = {
                        ...
                        "public_ipv6": network_interface.access_configs[
                            0
                        ].external_ipv6,
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            locations: list[str] = (
                kwargs.get("locations").split(",") if kwargs.get("locations") else []
            )
            network_tags: list[str] = (
                kwargs.get("network_tags").split(",")
                if kwargs.get("network_tags")
                else []
            )
            ...
            try:
                ...
                with concurrent.futures.ThreadPoolExecutor(
                    ...
                    results = executor.map(
                        ...
                        locations,
                        itertools.repeat(project_id),
                        itertools.repeat(compute_client),
                        itertools.repeat(network_tags),
                        itertools.repeat(firewall_detail),
                    )
