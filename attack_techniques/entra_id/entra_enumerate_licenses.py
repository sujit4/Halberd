...
class EntraEnumerateLicenses(BaseTechnique):
    def __init__(self):
        ...
        technique_notes = [
            TechniqueNote(
                "If no target user is specified, the current authenticate user licenses are enumerated."
            )
        ]
        super().__init__(
        ...
        try:
            ...
            if target_user:
                ...
                if "error" in user_response:
                    return ExecutionStatus.FAILURE, {
                        "error": {
                            ...
                            "error_detail": user_response.get("error").get(
                                "message", "N/A"
                            ),
                        },
                ...
                if "error" in user_info:
                    user_info = {
                        "userPrincipalName": "current user",
            ...
            for license in raw_response:
                ...
                enabled_services = [
                    service_plan
                    for service_plan in license.get("servicePlans", [])
                ...
                license_entry = {
                    "license_name": self._get_friendly_license_name(
                        license.get("skuPartNumber", "")
                    ),
                    ...
                    "enabled_service_plans": [
                        {
                            ...
                            "provisioning_status": service.get(
