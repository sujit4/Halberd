...
class EntraReconTenantInfo(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            "Recon Tenant Info",
            "Recon information related to the target Microsoft tenant ",
            mitre_techniques,
        )
        ...
        try:
            ...
            if authenticated:
                return ExecutionStatus.SUCCESS, {
                    "message": "Successfully gathered tenant information",
                    "value": {
                        "display_name": raw_response.get("displayName", "N/A"),
                        "tenant_id": raw_response.get("tenantId", "N/A"),
                        "default_domain_name": raw_response.get(
                            "defaultDomainName", "N/A"
                        ),
                        "federation_brand_name": raw_response.get(
                ...
                match = re.search(
                    pattern, raw_response["token_endpoint"], re.IGNORECASE
                )
