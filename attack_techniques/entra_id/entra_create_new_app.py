...
class EntraCreateNewApp(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "Create a new application in Entra ID which can allow persistence or privilege escalation. Optionally, choose to add service principal for the newly created app.",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            create_service_principal: bool = kwargs.get(
            ...
            if 200 <= raw_response.status_code < 300:
                ...
                if create_service_principal:
                    ...
                    service_principal_payload = {"appId": raw_response.json()["appId"]}

                    # Attempt to create app SP
                    sp_response = GraphRequest().post(
                        url=service_principal_url, data=service_principal_payload
                    )
