...
class EntraGenerateAppCredentials(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "Generates new secret for an application in Entra ID that can be used for persistence or privilege escalation",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            data = {"passwordCredential": {"displayName": cred_display_name}}
            ...
            if 200 <= raw_response.status_code < 300:
                return ExecutionStatus.SUCCESS, {
                    "message": "Successfully generated application credentials",
                    "value": {
                        ...
                        "custom_key_id": raw_response.json().get(
                            "customKeyIdentifier", "N/A"
                        ),
                        "start_date_time": raw_response.json().get(
                            "startDateTime", "N/A"
                        ),
    ...
    def get_parameters(self) -> Dict[str, Dict[str, Any]]:
        return {
            ...
            "cred_display_name": {
                ...
                "required": True,
                "default": None,
                "name": "New Credential Display Name",
                "input_field_type": "text",
            },
        }
