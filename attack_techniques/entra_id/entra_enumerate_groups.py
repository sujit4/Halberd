...
class EntraEnumerateGroups(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            "Enumerate Groups", "Enumerates groups in Entra ID", mitre_techniques
        )
                    ...
                    (
                        {
                            ...
                            "assignable_role": application_info.get(
                                "isAssignableToRole", "N/A"
                            ),
                            "membership_rule": application_info.get(
                                "membershipRule", "N/A"
                            ),
                            "security_enabled": application_info.get(
                                "securityEnabled", "N/A"
                            ),
