...
class EntraAssignLicense(BaseTechnique):
    def __init__(self):
        ...
        technique_refs = [
            TechniqueReference(
                "Microsoft Graph API - assignLicense",
                "https://learn.microsoft.com/en-us/graph/api/user-assignlicense",
            ),
            TechniqueReference(
                "Common Microsoft 365 License SKU IDs",
        ...
        technique_notes = [
            TechniqueNote(
                "Common SKUs: Office 365 E3 (6fd2c87f-b296-42f0-b197-1e91e994b900), Office 365 E5 (c7df2760-2c81-4ef7-b578-5b5392b571df)"
            ),
            TechniqueNote(
                "Assigning E5 licenses can grant high-privilege features like eDiscovery access"
            ),
        ]
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            if disabled_plans:
                ...
                disabled_service_plans = [
                    plan.strip() for plan in disabled_plans.split(",")
                ]
            ...
            data = {
                "addLicenses": [
                    {"skuId": license_sku_id, "disabledPlans": disabled_service_plans}
                ],
                "removeLicenses": [],
            }
            ...
            if 200 <= raw_response.status_code < 300:
                ...
                return ExecutionStatus.SUCCESS, {
                    ...
                    "value": {
                        ...
                        "all_licenses": licenses_response
                        if not isinstance(licenses_response, dict)
                        or "error" not in licenses_response
                        else [],
                    },
                }
