...
class EntraCheckUserValidity(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            "Check User Validity",
            "Validates if the user/users exist in a target ",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            if username in [None, ""] and username_file is None:
            ...
            for user_name in user_list:
                # create request body
                request_body = {"username": user_name, "isOtherIdpSupported": True}
                ...
                if raw_response.status_code == 200:
                    ...
                    if target_info.get("IfExistsResult") == 0:
                        valid_users.append({"username": user_name, "user_valid": True})
                    else:
                        invalid_users.append(
                            {"username": user_name, "user_valid": False}
                        )
                else:
            ...
            return ExecutionStatus.SUCCESS, {
                ...
                "value": {"valid_users": valid_users, "invalid_users": invalid_users},
            }
        except Exception as e:
            return ExecutionStatus.FAILURE, {
                "error": str(e),
