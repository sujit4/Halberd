...
class EntraInviteExternalUser(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            ...
            "Invites any external user to grant access to the current tenant allowing persistence",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            endpoint_url = "https://graph.microsoft.com/v1.0/invitations"
            ...
            data = {
                ...
                "invitedUserMessageInfo": {"customizedMessageBody": invitation_message},
            }
            ...
            if 200 <= raw_response.status_code < 300:
                return ExecutionStatus.SUCCESS, {
                    ...
                    "value": {
                        "External User": raw_response.json().get(
                            "invitedUserEmailAddress", "N/A"
                        ),
                        "invited_user_type": raw_response.json().get(
                            "invitedUserType", "N/A"
                        ),
                        "invited_user_id": raw_response.json()
                        .get("invitedUser", "N/A")
                        .get("id", "N/A"),
                        "invitation_message": raw_response.json()
                        .get("invitedUserMessageInfo", "N/A")
                        .get("customizedMessageBody", "N/A"),
                        "invite_redeem_url": raw_response.json().get(
                            "inviteRedeemUrl", "N/A"
                        ),
