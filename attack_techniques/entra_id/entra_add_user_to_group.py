...
class EntraAddUserToGroup(BaseTechnique):
    def __init__(self):
        ...
        super().__init__(
            "Add User To Group",
            "Adds user to a target group in Entra ID",
            mitre_techniques,
        )
    ...
    def execute(self, **kwargs: Any) -> Tuple[ExecutionStatus, Dict[str, Any]]:
        ...
        try:
            ...
            if access_token:
                raw_response = GraphRequest().post(
                    url=endpoint_url, data=data, access_token=access_token
                )
            else:
            ...
            if 200 <= raw_response.status_code < 300:
                return ExecutionStatus.SUCCESS, {
                    ...
                    "value": {"Group": group_id, "User": user_id},
                }
            else:
                return ExecutionStatus.FAILURE, {
