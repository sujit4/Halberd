...
class EntraCredentialProvider(BaseCredentialProvider):
    ...
    def classify_credential(self, access_token: str) -> tuple:
        ...
        try:
            ...
            try:
                ...
                detail = (
                    f"Expires: {exp_time_str[:16].replace('T', ' ')}"
                    if exp_time_str
                    else ""
                )
            except Exception:
            ...
            cred_data = CredentialData(
                ...
                raw_data={"token": access_token, "exp_time": exp_time_str},
            )
    ...
    def delete_credential(
        ...
        try:
            ...
            if (
                credential_data
                and credential_data.raw_data
                and "token" in credential_data.raw_data
            ):
    ...
    def set_active_credential(self, credential_data: CredentialData) -> str:
        ...
        try:
            ...
            return (
                f"Entra credential '{credential_data.name}' set as active successfully!"
            )
        except Exception as e:
