...
from core.Functions import ParseTechniqueResponse, generate_attack_trace_table
            ...
            html.H2(
                [
                    ...
                    html.A(
                        ...
                        href="https://github.com/vectra-ai-research/Halberd/wiki/UI-&-Navigation#attack-history",
                        target="_blank",
                    ),
                ],
                                        ...
                                        [
                                            dbc.Col(
                                                [
                                                    ...
                                                    dbc.Row(
                                                        html.P(
                                                            "Select Execution From Table to View Output"
                                                        )
                                                    ),
                                                ]
                                            )
...
@callback(
    Output(
        component_id="output-viewer-display-div",
