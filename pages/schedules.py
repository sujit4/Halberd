    ...
    table_header = [
        html.Thead(
            html.Tr(
                [
                    html.Th("Schedule ID"),
                    html.Th("Playbook Name"),
                    html.Th("Start Date"),
                    html.Th("End Date"),
                    html.Th("Repeat"),
                    html.Th("Repeat Frequency"),
                    html.Th("Time"),
                ]
            )
        )
    ...
    for schedule in schedules:
        table_entries.append(
            html.Tr(
                [
                    html.Td(schedule),
                    html.Td(schedules[schedule]["Playbook_Id"]),
                    html.Td(schedules[schedule]["Start_Date"]),
                    html.Td(schedules[schedule]["End_Date"]),
                    html.Td(schedules[schedule]["Repeat"]),
                    html.Td(schedules[schedule]["Repeat_Frequency"]),
                    html.Td(schedules[schedule]["Execution_Time"]),
                ]
            )
        )
        ...
        [
            html.H2(
                [
                    ...
                    html.A(
                        DashIconify(
                            icon="mdi:help-circle-outline", width=18, height=18
                        ),
                        href="https://github.com/vectra-ai-research/Halberd/wiki/UI-&-Navigation",
                        target="_blank",
                    ),
                ],
