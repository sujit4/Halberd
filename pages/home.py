...
from version import __author__, __repository__, __version__
                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.Span(
                                    "For authorized security testing only. Ensure proper permissions before proceeding.",
                                                                ...
                                                                [
                                                                    html.Div(
                                                                        [
                                                                            html.H5(
                                                                                tactic,
                                                                                className="tactic-name mb-1",
                                                                            ),
                                                                            html.Span(
                                                                                f"{len(tactics_dict[tactic])} techniques",
                                                                                className="tactic-count",
                                                                            ),
                                                                        ],
                                                ...
                                                html.Tbody(
                                                    [
                                                        html.Tr(
                                                                ...
                                                                html.Td(
                                                                    [
                                                                        dbc.Button(
                                                                                ...
                                                                                html.Div(
                                                                                    [
                                                                                        ...
                                                                                        html.Span(
                                                                                            ...
                                                                                            className=f"platform-tag platform-{CATEGORY_MAPPING.get(tactics_dict[tactic][i]['surface'], tactics_dict[tactic][i]['surface']).lower()}"
                                                                                            if i
                                                                                            < len(
                                                                                                tactics_dict[
                                                                                                    tactic
                                                                            ...
                                                                            style={
                                                                                "minHeight": "120px",
                                                                                "background": "linear-gradient(135deg, rgba(52, 58, 64, 0.8) 0%, rgba(33, 37, 41, 0.8) 100%)"
                                                                                if i
                                                                                < len(
                                                                                    tactics_dict[
                                                                                        tactic
                                                            ...
                                                            className="matrix-technique-row",
                                                        )
